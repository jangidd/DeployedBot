  ...
  elements: [
    {
      ...
      elements: [
          ...
          elements: [
            {
              type: "Control",
              label: "Name",
              scope: "#/properties/NameTextFR25",
            },
            {
              type: "Control",
              label: "Patient ID",
              scope: "#/properties/IDTextFR25",
            },
            {
              type: "Control",
              label: "Age",
              scope: "#/properties/AgeTextFR25",
            },
            {
              type: "Control",
              label: "Test date",
              scope: "#/properties/TestDateTextFR25",
            },
            {
              type: "Control",
              label: "Report date",
              scope: "#/properties/ReportDateTextFR25",
            },
          ],
        },

        {
          type: "Control",
          label: "Gender",
          scope: "#/properties/GenderTextFR25",
          options: {
            format: "radio",
          },
        },
...
export default class Form25 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: props.data,
  ...
  patientSelected(e) {
    ...
    let formData = {
      ...data,
      GenderTextFR25: patient.gender,
      AgeTextFR25: patient.age,
      NameTextFR25: patient.PatientName,
      IDTextFR25: patient.PatientId,
      TestDateTextFR25: patient.TestDate,
      ReportDateTextFR25: patient.ReportDate,
    };
