  ...
  elements: [
    {
      ...
      elements: [
          ...
          elements: [
            {
              type: "Control",
              label: "Name",
              scope: "#/properties/NameTextFR1",
            },
            {
              type: "Control",
              label: "Patient ID",
              scope: "#/properties/IDTextFR1",
            },
            {
              type: "Control",
              label: "Age",
              scope: "#/properties/AgeTextFR1",
            },
            {
              type: "Control",
              label: "Test date",
              scope: "#/properties/TestDateTextFR1",
            },
            {
              type: "Control",
              label: "Report date",
              scope: "#/properties/ReportDateTextFR1",
            },
          ],
        },

        {
          type: "Control",
          label: "Gender",
          scope: "#/properties/GenderTextFR1",
          options: {
            format: "radio",
          },
        },
