  ...
  elements: [
    {
      ...
      elements: [
          ...
          elements: [
            {
              type: "Control",
              label: "Name",
              scope: "#/properties/NameTextFR11",
            },
            {
              type: "Control",
              label: "Patient ID",
              scope: "#/properties/IDTextFR11",
            },
            {
              type: "Control",
              label: "Age",
              scope: "#/properties/AgeTextFR11",
            },
            {
							type: "Control",
							label: "Test date",
							scope: "#/properties/TestDateTextFR11",
						},
                        {
							type: "Control",
							label: "Report date",
							scope: "#/properties/ReportDateTextFR11",
						},
          ],
        ...
        },
        {
          type: "Control",
          label: "Gender",
          scope: "#/properties/GenderTextFR11",
          options: {
            format: "radio",
          },
        },
...
export default class Form11 extends Component {
	...
	patientSelected(e) {
		...
		let formData = {
			...data,
			GenderTextFR11: patient.gender,
			AgeTextFR11: patient.age,
			NameTextFR11: patient.PatientName,
			IDTextFR11: patient.PatientId,
			TestDateTextFR11: patient.TestDate,
			ReportDateTextFR11: patient.ReportDate
		}
