...
import "../style.css";
import PopUp from "../PopUps/PopupOptometry3";
...
class Optometry3 extends Component {
	constructor(props) {
		super(props);
		this.state = {
			frmData: {
	...
	async formatData() {
		...
		if (frmData.NameTextFR25 && frmData.IDTextFR25 && frmData.AgeTextFR25 && frmData.GenderTextFR25)
        {
          report += "<pre>" + "<b>" +"<header>" + "<table>" + "<tr>" + "<td>" + "Name: " + frmData.NameTextFR25 + "</td>" + "<td>" + "Patient ID: " + frmData.IDTextFR25 + "</td>" + "<td>" + "Age: " + frmData.AgeTextFR25 + "</td>" + "</tr>"  + "<tr>" + "<td>" + "Gender: " + frmData.GenderTextFR25 + "</td>" + "<td>" + "Test date: " + frmData.TestDateTextFR25 + "</td>" + "<td>" + "Report date: " + frmData.ReportDateTextFR25 + "</td>" + "</tr>" + "</table>" + "</b>" + "</pre>" + "</header>";
